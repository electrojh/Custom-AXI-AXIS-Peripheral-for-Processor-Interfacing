...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    unsigned int clk_cnt = stop_time-start_time;
    printf("Elapsed time in clocks = %u\n",clk_cnt);
    unsigned int bytes_transferred = 8192; // change obviously
    float time_spent = (float) (1/125e6)*clk_cnt; // change obviously
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 10 Cameron Coleman - Custom Peripheral Demonstration\n\r");
